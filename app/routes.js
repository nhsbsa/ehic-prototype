...
router.use('/current/dependants', require('./views/current/dependants/_routes'));
...
router.use('/sprint-041', require('./views/sprint-041/_routes'));
...
router.use('/sprint-043', require('./views/sprint-043/_routes'));
router.use('/sprint-043/apply', require('./views/sprint-043/apply/_routes'));
